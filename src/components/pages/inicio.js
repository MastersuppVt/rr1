...
import backDonate from "../assets/backDonate.jpg"
import byn from "../assets/byn.png"
        ...
        <div>
             {/* <div class="loader" id="loader">
                <div id="barraProgreso">
                    <div class="cargando">
                        <img src={byn} height="100%" alt=""></img>
                    </div>
                    <div class="cargado" id="cargado">
                        <img src={color} height="100%" alt=""></img>
                    </div>
            ...
            <div class="contenedor">
                    ...
                    <div class="barrasup">
                        <nav>
                            <div class="barra" id="barra">
                                <a href="#barra"><img class="logo" src={color} alt="icono mastersupp"
                                    title="Icono"></img></a>
                    ...
                    <div class="contenedorAsk" id="contenedorAsk">
                        <div>
                            ...
                            <form action="#" class="form">
                                <a href="#close"><img alt="close" src="../assets/close.png" class="closeBtmI"></img></a>
                ...
                <div class="secTres">
                    ...
                    <a href="index.html"><img src={color} alt="icono mastersupp" width="64" height="64"
                        title="Icono"></img></a>
                ...
                <section class="esteNo">
                    ...
                    <div class="secCinco">
                        <div align="center" id="videos">
                            ...
                            <iframe title="v1" src="https://www.youtube.com/embed/crBtGaM7YE0" frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowfullscreen></iframe>
                            <iframe title="v2" src="https://www.youtube.com/embed/oQsbZK7Ozag" frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowfullscreen></iframe>


                            <iframe title="v3" src="https://www.youtube.com/embed/DR278P-3tDE" frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowfullscreen></iframe>
                            <iframe title="v4" class="xs" src="https://www.youtube.com/embed/smFgDJO526E"
                                frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowfullscreen></iframe>
                ...
                <section>
                    <div class="secSiete">
                        ...
                        <div>
                            <iframe title="calendar" src="https://calendar.google.com/calendar/embed?src=6gkoc737noh2lnup5ootde94cc%40group.calendar.google.com&ctz=America%2FSantiago" frameborder="0" scrolling="no"></iframe>
                        </div>
                    </div>
                </section>
